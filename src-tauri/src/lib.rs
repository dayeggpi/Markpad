...
#[tauri::command]
fn open_markdown_preview(path: String, max_bytes: usize) -> Result<(String, String, bool), String> {
    use std::io::Read;
    ...
    let mut preview_content = String::from_utf8_lossy(&vec_buf).into_owned();
    if !preview_content.ends_with('\n') {
